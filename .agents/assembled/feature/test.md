...
**Activity log** (`logs/activity-log-format.md`): One entry per phase per task. Include: test count, any fixes made with before/after assertion, any unexpected passes in Phase 1, any escalated failures in Phase 2.

**Issue log** (`logs/issue-log-format.md`): Every Phase 1 unexpected pass and every Phase 2 test failure gets an issue log entry at P1 severity.
