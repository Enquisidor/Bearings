...
Append findings to `.logs/issues.md` using the format in `logs/issue-log-format.md`. Every finding must cite the specific spec artifact and section that was violated, the exact file path and line of the deviation, and a specific remediation.
